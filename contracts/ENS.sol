...
contract ZENS {
    ...
    function setDomain(string memory _name, uint _yearToBook) public payable {
        require(Domains[_name].owner == address(0) || block.timestamp > Domains[_name].creatingTime + 31536000, "This name is busy");
    ...
    function extandDomain (uint _yearsToExtand, string memory _name) public payable {
